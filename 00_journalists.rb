...
question_number = 1
  while question_number != 0
    ...
    puts "#8 La flemme de l'énoncé de 3 km mais la 8 quoi t'as compris"
    puts "#0 Quitter"
    puts
    puts "Entrez le numéro de question:"
    print "> "
  ...
  puts "LA QUESTION EST VITE REPONDUE"
